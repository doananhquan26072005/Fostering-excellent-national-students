...
bool check( int x, int y, int k) {
    for (int i = 1; i <= n ; i++) {
        if (a[x][i] == nt[k]) return false;
    }
    for (int i = 1; i <= n ; i++) {
        if (a[i][y] == nt[k]) return false;
    }
    return true;
}
...
signed main() {
    ...
    nt[1] = 2; nt[2] = 3; nt[3] = 5; nt[4] = 7; nt[5] = 11; nt[6] = 13; nt[7] = 17; nt[8] = 19;
    nt[9] = 23; nt[10] = 29; nt[11] = 31; nt[12] = 37; nt[13] = 41; nt[14] = 43; nt[15] = 47;
    cin >> n;
    FOR(i , 1 , n)
        FOR(j , 1 , n)cin >> a[i][j];
    sol(1, 1);
