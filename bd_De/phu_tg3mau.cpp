...
signed main() {
    ...
    REP(z , t) {
        ...
        FOR(i , 1 , n - 3) {
            if (check == 1)break;
            // cout << a[a[dc[i].x].fi].fi << " " << dc[i].y << endl;
            if (a[a[dc[i].x].fi].fi == dc[i].y) {
                ...
                // cout << a[dc[i].x].se << " " <<a[a[dc[i].x].fi].se<< " "<< dc[i].color << endl;
            }
            else {
                check = 1;
            }
        }
        if (check == 1)cout << "neispravna triagulacija" << endl;
        else if (check == 2)cout << "neispravno bojenje" << endl;
