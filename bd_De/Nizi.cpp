...
signed main() {
    ...
    int l = 1 , r = n , fir = 1 , las = n ,ans = 0 , res = n - 1;
    while(l < r){
        // cout << l << " " << r << " " << fir << " " << las << endl;
        if(a[las] == a[fir]){
            l += 1; r -= 1;
            fir = l;
            las = r;
        ...
        else if(F[l] - F[fir - 1] < F[las] - F[r - 1])l += 1;
        else if(F[l] - F[fir - 1] > F[las] - F[r - 1])r -= 1;
        else if(F[l] - F[fir - 1] == F[las] - F[r - 1]){
            ans += (l - fir) + (las - r);
            l += 1; r -= 1;
            fir = l;
            las = r;
